...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202408151656-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  99-nginx.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Thursday, Aug 15, 2024 16:56 EDT
# @@File             :  99-nginx.sh
# @@Description      :
...
STIKKED_SITE_NAME="${STIKKED_SITE_NAME:-CasjaysDev PasteBin}"
STIKKED_CRON_KEY="${STIKKED_CRON_KEY:-$(__random_password 16)}"
STIKKED_ADMIN_PASS="${STIKKED_ADMIN_PASS:-$(__random_password 16)}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
ADDITIONAL_CONFIG_DIRS="/config/stikked"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  __replace "REPLACE_STIKKED_CRON_KEY" "$STIKKED_CRON_KEY" "/config/stikked/config.php"
  __replace "REPLACE_STIKKED_ADMIN_PASS" "$STIKKED_ADMIN_PASS" "/config/stikked/config.php"
